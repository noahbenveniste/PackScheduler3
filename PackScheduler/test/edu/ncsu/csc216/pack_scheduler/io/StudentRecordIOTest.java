...
public class StudentRecordIOTest {
	...
	/** Expected results for valid students */
	private final String [] validStudents = {validStudent0, validStudent1, validStudent2, validStudent3, validStudent4, validStudent5, validStudent6, validStudent7, validStudent8, validStudent9 };
	...
	public void testReadValidStudentRecords() {
		try {
			...
			assertEquals("Stone", students.get(9).getLastName());
