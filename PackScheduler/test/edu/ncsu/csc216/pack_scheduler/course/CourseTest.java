...
public class CourseTest {
    ...
    public void testSetInstructorId() {
        ...
        // //Test that setting the instructor id to null doesn't change the instructor
        // id (or anything else).
        // try {
    ...
    public void testToString() {
        Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
                END_TIME);
        String s1 = "CSC216,Programming Concepts - Java,001,4,sesmith5,35,MW,1330,1445";
        assertEquals(s1, c1.toString());

        Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, "A");
        String s2 = "CSC216,Programming Concepts - Java,001,4,sesmith5,35,A";
    ...
    public void testCompareTo() {
        ...
        Course c3 = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
                END_TIME);
        Course c4 = new Course(NAME, TITLE, "003", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
                END_TIME);
        ...
        assertEquals(c4.compareTo(c1), -c1.compareTo(c4));
